...
export default function Watchlist() {
  ...
  return (
    <div className="space-y-8">
      <div className="flex items-center justify-between">
        ...
        <div className="flex gap-3">
          <input
            ...
            className="bg-white/5 border border-white/20 px-4 py-3 rounded-2xl focus:outline-none focus:border-cyan-400"
          />
          <button onClick={handleAdd} className="px-6 py-3 bg-cyan-600 rounded-2xl flex items-center gap-2 hover:bg-cyan-500 transition">
            <Plus size={18} /> Add
          </button>
        </div>
      </div>
      ...
      {myList.length === 0 ? (
        <div className="text-center py-20 text-gray-400 text-xl">Your watchlist is empty — add symbols above!</div>
      ) : (
          ...
          {myList.map(sym => {
            ...
            return (
              <motion.div
                ...
                className="bg-white/5 backdrop-blur-xl border border-white/10 rounded-3xl p-6 cursor-pointer group"
